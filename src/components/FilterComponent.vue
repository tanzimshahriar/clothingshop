<template>
  <div>
    <v-col
      class="my-0 mx-0 py-0 px-0 font-weight-regular hidden-sm-and-down overline"
      >Filter</v-col
    >
    <v-row justify="center" align="center">
      ...
      <v-col align="start" cols="12" sm="6" md="3" xl="3" class="py-0">
        <v-col class="px-0 mt-2 mb-0 mx-8 py-0 font-weight-medium"
          >PRICE BETWEEN</v-col
        >
        <v-range-slider
          v-model="range"
        ...
        >
          <template v-slot:prepend>
            <v-card-text class="px-0 py-0 mx-0 my-0 font-weight-light"
              >${{ range[0] }}</v-card-text
            >
          </template>
